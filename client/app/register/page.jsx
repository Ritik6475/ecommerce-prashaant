...
const RegisterSideImage = "https://images.bewakoof.com/uploads/grid/app/1x1-graphic-edition-women-1762163207.jpg";
          ...
          <div className="space-y-4">
            ...
            <div className="relative my-4">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-gray-50 text-gray-500">Or with email</span>
              </div>
            </div>
          </div>
