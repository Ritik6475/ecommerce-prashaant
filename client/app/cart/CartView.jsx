    ...
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center p-4 bg-gray-50">
        <div className="max-w-md w-full bg-white p-8 rounded-xl shadow-sm border border-gray-200 text-center">
          ...
          <Link
            href="/login"
            className="inline-block bg-black text-white px-6 py-3 rounded-lg font-medium hover:bg-gray-800 transition-colors w-full"
          >
            Login
          </Link>
        </div>
    ...
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center p-4 bg-gray-50">
        <div className="max-w-md w-full bg-white p-8 rounded-xl shadow-sm border border-gray-200 text-center">
          ...
          <Link
            href="/products"
            className="inline-flex items-center justify-center bg-black text-white px-6 py-3 rounded-lg font-medium hover:bg-gray-800 transition-colors w-full"
          >
            Browse Products
          </Link>
        </div>
        ...
        <div className="bg-gray-100 rounded-lg p-4 mb-6 flex items-start">
          ...
          <div>
            <p className="font-semibold text-sm">
              Buy 2 for 1099 offer applied!
            </p>
            <p className="text-xs text-gray-600 mt-1">
              Add 1 more item to save more.
            </p>
          </div>
        </div>
                  ...
                  <div className="flex-1 min-w-0">
                    <div>
                      ...
                      <div className="flex items-center mt-2 text-xs text-green-600">
                        ...
                        <p className="mt-1">Ships within a few days!</p>
                      </div>
                    </div>
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-5 shadow-sm sticky top-6">
              ...
              <div className="mt-5 p-3 bg-gray-50 rounded-lg border border-gray-200">
                ...
                <p className="text-xs text-gray-700">
                  Use{" "}
                  <span className="font-bold bg-gray-200 px-1.5 py-0.5 rounded text-xs">
                    GETCASH10
                  </span>{" "}
                  for extra 10% cashback.
                </p>
              </div>
